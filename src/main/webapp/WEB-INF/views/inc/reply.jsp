			...
			<tbody>
				<c:forEach items="${ replyList }" var="reply">
					<tr>
						...
						<td><a
							href="${ pageContext.request.contextPath }/deleteOneReviewReply?reviewId=${ reviewById.reviewId }&replyId=${ reply.replyId }"
		...
		<div class="container">
			<form:form modelAttribute="newReply" method="post">
				<div class="container">
					...
					<form:input type="text" class="form-control mb-2"
						path="replyContent" oninput="trimSpaceStart(this)"
