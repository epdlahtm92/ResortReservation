		...
		<form:form modelAttribute="newNotification" class="form-horizontal" method="post">
			<fieldset>
				...
				<div class="form-group-row">
					...
					<div class="col -sm-3">
						<form:input path="notificationTitle" class="form-control" required="true" />
					</div>
				</div>
				<div class="form-group-row">
					<label class="col-sm-2 control-label">내용</label>
					<div class="col -sm-3">
						<form:textarea style="height:500px;" path="notificationContent" class="form-control" required="true" />
					</div>
				</div>
