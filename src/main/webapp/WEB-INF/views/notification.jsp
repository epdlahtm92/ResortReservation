		...
		<div class="row">
			<div class="col -md-4">
				<div class="container" style="text-align:center;">
					...
					<p>
						<b>작성자 : </b><c:out value="관리자" /><br />
						<b>날짜 : </b><c:out value="${ notificationById.notificationDate }" />
					<p>
						<b>내용 : </b> <br />
						<h5><c:out value="${ notificationById.notificationContent }" /></h5>
				</div>
			</div>
			<div class="col -md-8">
				<img style="margin-bottom:50px; width: 100%;"
